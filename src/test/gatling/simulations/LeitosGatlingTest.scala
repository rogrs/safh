...
/**
 * Performance test for the Leitos entity.
 */
class LeitosGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Leitos entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created leitos")
                .get("${new_leitos_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created leitos")
            .delete("${new_leitos_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
