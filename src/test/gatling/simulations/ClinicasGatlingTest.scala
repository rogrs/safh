...
/**
 * Performance test for the Clinicas entity.
 */
class ClinicasGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Clinicas entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created clinicas")
                .get("${new_clinicas_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created clinicas")
            .delete("${new_clinicas_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
