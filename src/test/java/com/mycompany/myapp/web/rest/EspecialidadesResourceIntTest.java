...
public class EspecialidadesResourceIntTest {
    ...
    public void initTest() {
        ...
        especialidades.setDescricao(DEFAULT_DESCRICAO);
    }
    ...
    public void createEspecialidades() throws Exception {
        ...
        assertThat(testEspecialidades.getDescricao()).isEqualTo(DEFAULT_DESCRICAO);
    ...
    public void checkDescricaoIsRequired() throws Exception {
        ...
        // set the field null
        especialidades.setDescricao(null);
    ...
    public void updateEspecialidades() throws Exception {
        ...
        updatedEspecialidades.setDescricao(UPDATED_DESCRICAO);
        ...
        Especialidades testEspecialidades = especialidades.get(especialidades.size() - 1);
        assertThat(testEspecialidades.getDescricao()).isEqualTo(UPDATED_DESCRICAO);
