...
import com.mycompany.myapp.repository.DietasRepository;
import com.mycompany.myapp.repository.search.DietasSearchRepository;
...
public class DietasResourceIntTest {
    ...
    private static final String DEFAULT_DIETA = "AAAAA";
    private static final String UPDATED_DIETA = "BBBBB";
