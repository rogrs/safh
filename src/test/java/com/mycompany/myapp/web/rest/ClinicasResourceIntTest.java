...
import com.mycompany.myapp.repository.ClinicasRepository;
import com.mycompany.myapp.repository.search.ClinicasSearchRepository;
...
public class ClinicasResourceIntTest {
    ...
    private static final String DEFAULT_CLINICA = "AAAAA";
    private static final String UPDATED_CLINICA = "BBBBB";
