...
public class LeitosResourceIntTest {
    ...
    public void initTest() {
        ...
        leitos = new Leitos();
        leitos.setDescricao(DEFAULT_DESCRICAO);
    ...
    public void createLeitos() throws Exception {
        ...
        assertThat(testLeitos.getDescricao()).isEqualTo(DEFAULT_DESCRICAO);
    ...
    public void updateLeitos() throws Exception {
        ...
        updatedLeitos.setDescricao(UPDATED_DESCRICAO);
        ...
        Leitos testLeitos = leitos.get(leitos.size() - 1);
        assertThat(testLeitos.getDescricao()).isEqualTo(UPDATED_DESCRICAO);
