...
export class PrescricoesComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.prescricoesService.search({
    ...
    trackId(index: number, item: Prescricoes) {
        return item.id;
    }
    registerChangeInPrescricoes() {
        this.eventSubscriber = this.eventManager.subscribe('prescricoesListModification', (response) => this.reset());
    }
