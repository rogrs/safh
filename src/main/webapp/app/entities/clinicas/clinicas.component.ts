...
export class ClinicasComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: Clinicas) {
        return item.id;
    }
    registerChangeInClinicas() {
        this.eventSubscriber = this.eventManager.subscribe('clinicasListModification', (response) => this.reset());
    }
