...
import { getEntity, deleteEntity } from './clinicas.reducer';

export interface IClinicasDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export class ClinicasDeleteDialog extends React.Component<IClinicasDeleteDialogProps> {
  componentDidMount() {
    this.props.getEntity(this.props.match.params.id);
  }

  confirmDelete = event => {
    this.props.deleteEntity(this.props.clinicasEntity.id);
