  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            Clinicas [<b>{clinicasEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            <dt>
              <span id="clinica">Clinica</span>
            </dt>
          ...
          <Button tag={Link} to="/entity/clinicas" replace color="info">
            <FontAwesomeIcon icon="arrow-left" /> <span className="d-none d-md-inline">Back</span>
          </Button>
          &nbsp;
          <Button tag={Link} to={`/entity/clinicas/${clinicasEntity.id}/edit`} replace color="primary">
