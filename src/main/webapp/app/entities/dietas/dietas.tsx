...
import { getSearchEntities, getEntities, reset } from './dietas.reducer';
...
export interface IDietasState extends IPaginationBaseState {
  search: string;
}
            ...
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('dieta')}>
                    Dieta <FontAwesomeIcon icon="sort" />
                  </th>
...
const mapStateToProps = ({ dietas }: IRootState) => ({
  ...
  totalItems: dietas.totalItems,
  links: dietas.links,
  entity: dietas.entity,
  updateSuccess: dietas.updateSuccess
});
