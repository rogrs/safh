...
export class InternacoesComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.internacoesService.search({
    ...
    trackId(index: number, item: Internacoes) {
        return item.id;
    }
    registerChangeInInternacoes() {
        this.eventSubscriber = this.eventManager.subscribe('internacoesListModification', (response) => this.reset());
    }
