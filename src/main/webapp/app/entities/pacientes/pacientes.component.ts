...
export class PacientesComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: Pacientes) {
        return item.id;
    }
    registerChangeInPacientes() {
        this.eventSubscriber = this.eventManager.subscribe('pacientesListModification', (response) => this.reset());
    }
