...
export class FabricantesComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.fabricantesService.search({
    ...
    trackId(index: number, item: Fabricantes) {
        return item.id;
    }
    registerChangeInFabricantes() {
        this.eventSubscriber = this.eventManager.subscribe('fabricantesListModification', (response) => this.reset());
    }
