...
export class EnfermariasComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.enfermariasService.search({
    ...
    trackId(index: number, item: Enfermarias) {
        return item.id;
    }
    registerChangeInEnfermarias() {
        this.eventSubscriber = this.eventManager.subscribe('enfermariasListModification', (response) => this.reset());
    }
