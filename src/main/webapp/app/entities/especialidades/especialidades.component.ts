...
export class EspecialidadesComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.especialidadesService.search({
    ...
    registerChangeInEspecialidades() {
        this.eventSubscriber = this.eventManager.subscribe('especialidadesListModification', (response) => this.reset());
    }
    ...
    private onSuccess(data, headers) {
        ...
        for (let i = 0; i < data.length; i++) {
            this.especialidades.push(data[i]);
        }
    }
