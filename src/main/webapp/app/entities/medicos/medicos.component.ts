...
export class MedicosComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: Medicos) {
        return item.id;
    }
    registerChangeInMedicos() {
        this.eventSubscriber = this.eventManager.subscribe('medicosListModification', (response) => this.reset());
    }
