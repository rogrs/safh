...
export class PosologiasComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: Posologias) {
        return item.id;
    }
    registerChangeInPosologias() {
        this.eventSubscriber = this.eventManager.subscribe('posologiasListModification', (response) => this.reset());
    }
