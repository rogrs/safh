...
import { getSearchEntities, getEntities, reset } from './posologias.reducer';
...
export interface IPosologiasState extends IPaginationBaseState {
  search: string;
}
            ...
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('posologia')}>
                    Posologia <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
...
const mapStateToProps = ({ posologias }: IRootState) => ({
  ...
  totalItems: posologias.totalItems,
  links: posologias.links,
  entity: posologias.entity,
  updateSuccess: posologias.updateSuccess
});
