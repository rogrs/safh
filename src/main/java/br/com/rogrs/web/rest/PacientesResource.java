...
public class PacientesResource {
    ...
    public ResponseEntity<Pacientes> getPacientes(@PathVariable String id) {
    ...
    public ResponseEntity<Void> deletePacientes(@PathVariable String id) {
    ...
    public List<Pacientes> searchPacientes(@RequestParam String query) {
        log.debug("REST request to search Pacientes for query {}", query);
        return StreamSupport
            .stream(pacientesSearchRepository.search(queryStringQuery(query)).spliterator(), false)
