...
public class InternacoesResource {
     ...
     * or with status 500 (Internal Server Error) if the internacoes couldn't be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    ...
    public ResponseEntity<Internacoes> updateInternacoes(@Valid @RequestBody Internacoes internacoes) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, internacoes.getId().toString()))
            .body(result);
    }
    ...
    @Timed
    public ResponseEntity<List<Internacoes>> getAllInternacoes(@ApiParam Pageable pageable) {
    ...
    public ResponseEntity<Internacoes> getInternacoes(@PathVariable Long id) {
        ...
        return ResponseUtil.wrapOrNotFound(Optional.ofNullable(internacoes));
    }
    ...
    @Timed
    public ResponseEntity<List<Internacoes>> searchInternacoes(@RequestParam String query, @ApiParam Pageable pageable) {
